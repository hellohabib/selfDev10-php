...
//***********************************************************
//              007-7. array_merge(); - ফাংশন
//***********************************************************
// array_merge() এই ফাংশন দিয়ে দুটি এরে কে মার্জ বা একত্রিকরন করা হয়।
// এর প্যারা মিটার হবে ইউজারের ইচ্ছা মত। যত গুলা এরে মার্জ করতে চাই ফাংশনের প্যারামিটার তত গুলাই হতে পারে।
// প্যারামিটারে এরের ক্রম যেভাবে লিখা হবে নতুন এরে তে সেভাবেই আইটেম আসবে
/*
$array1 = range('a','c');
print_r($array1);
$array2 = range('d','f');
...
$array3 = range('g','i');
print_r($array3);
$margedArray = array_merge($array1, $array3, $array2); 
print_r($margedArray);
*/

//***********************************************************
//              007-8. in_array(); - ফাংশন
//***********************************************************
// in_array() দিয়ে কোন এরের মধ্যে কোন আইটেম আছে কি না তা বের করা যায়। অনেকটা সার্চ এর মত।
// এর দুটি প্যারামিটার। প্রথমঃ কি খুজতে চাই, দ্বিতীয়ঃ কোন এরের মধ্যে খুজতে চাই
/*
$myArray=['aa','bb','cc','dd']; 
echo "এরের মধ্যে আইটেম খুজে পেলে আউটপুট হবে 1, যেমনঃ\n";
echo in_array('bb', $myArray); // Output: 1
echo "\nএরের মধ্যে আইটেম খুজে না পেলে কিছুই আউটপুট দেখাবে না। যেমনঃ\n";
echo in_array('ee', $myArray); // Output: blank or nothing
*/

//***********************************************************
//              007-9. array_diff(); - ফাংশন
//***********************************************************

//***********************************************************
//              007-10. range(); - ফাংশন
//***********************************************************
$numbers=range(1,15,5);  // শুরুর পর থেকে প্রত্যেক পঞ্চম আইটেম এরে তে ঢুকবে
print_r($numbers);
$numbers=range(2,15,4); // শুরুর পর থেকে প্রত্যেক চতুর্থ আইটেম এরে তে ঢুকবে
print_r($numbers);
